...
namespace inpatient_management_system.dal
{
    ...
    public class postgresqlapisingleton
    {
        ...
        private string CONNECTION_STRING = @"Data Source=KMK\SQLEXPRESS;Database=inpatient_management_db;User Id=sa;Password=123456789";
        private string db_name = DBContract.DATABASE_NAME;//"inpatient_management_db";
        ...
        public bool createdatabase()
        {
            try
            {
                string _default_database_name = utilzsingleton.getInstance(_notificationmessageEventname).getappsettinggivenkey("postgresql_database", "inpatient_management_db");
            ...
            try
            {
                ...
                if (!does_doctors_table_exist_in_db)
                {
                    ...
                    string SQL_CREATE_DOCTORS_TABLE = " CREATE TABLE IF NOT EXISTS " + DBContract.doctors_entity_table.TABLE_NAME + " (" +
                          DBContract.doctors_entity_table.ID + " SERIAL PRIMARY KEY NOT NULL, " +
        ...
        public responsedto checkconnectionasadmin(postgresqlconnectionstringdto _connectionstringdto)
        {
            ...
            try
            {
                ...
                {
                    _responsedto.isresponseresultsuccessful = true;
                    _responsedto.responsesuccessmessage = "connection to postgresql successfull. doctors count [ " + count + " ].";
                    return _responsedto;
                }
                else
                {
        ...
        public responsedto update_user_in_database(user_dto _dto)
        {
            ...
            try
            {
                ...
                {
                    _responsedto.isresponseresultsuccessful = false;
                    //_responsedto.responseerrormessage = "Record update failed in " + DBContract.postgresql + ".";
                    _responsedto.responseerrormessage = "Record update failed.";
                    this._notificationmessageEventname.Invoke(this, new notificationmessageEventArgs(_responsedto.responseerrormessage, TAG));
                    return _responsedto;
                }
                else
                {
                    _responsedto.isresponseresultsuccessful = true;
                    _responsedto.responsesuccessmessage = "Record updated successfully.";
                    //_responsedto.responsesuccessmessage = "Record updated successfully in " + DBContract.postgresql + ".";
                    this._notificationmessageEventname.Invoke(this, new notificationmessageEventArgs(_responsedto.responsesuccessmessage, TAG));
                    return _responsedto;
                }
        ...
        public responsedto delete_user_in_database(user_dto _dto)
        {
            ...
            try
            {
                ...
                {
                    _responsedto.isresponseresultsuccessful = false;
                    //_responsedto.responseerrormessage = "Record deletion failed in " + DBContract.postgresql + ".";
                    _responsedto.responseerrormessage = "Record deletion failed.";
                    this._notificationmessageEventname.Invoke(this, new notificationmessageEventArgs(_responsedto.responseerrormessage, TAG));
                    return _responsedto;
                }
                ...
                {
                    _responsedto.isresponseresultsuccessful = true;
                    //_responsedto.responsesuccessmessage = "Record deleted successfully in " + DBContract.postgresql + ".";
                    _responsedto.responsesuccessmessage = "Record deleted successfully.";
                    this._notificationmessageEventname.Invoke(this, new notificationmessageEventArgs(_responsedto.responsesuccessmessage, TAG));
                    return _responsedto;
                }
